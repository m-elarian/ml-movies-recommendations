...
@app.route('/popularMoviesWithNames', methods=['GET'])
def homeWithNames():
    if 'movies_count' in request.args:
        movies_count= int(request.args['movies_count'])
        print (movies_count)
    else:
        movies_count = 10
    ...
    def get_high_rating_movies(movies_count):
       ...
       return high_score[['imdb_id','title']].head(movies_count)

    Lines =get_high_rating_movies(movies_count)['title']

    returnLine = ""
    # Strips the newline character
    for line in Lines:
        #print(line.strip()+",")
        returnLine = returnLine + line.strip()+"<br>"

    returnLine = returnLine[:-1]

    return "<b><font size=6 > " +returnLine+ " </font> </b> "

#============================================================================================
#============================================================================================

@app.route('/getHighRatingMoviesWithNames', methods=['GET'])
def getHighRatingMoviesWithNames():
    if 'movies_count' in request.args:
        movies_count= int(request.args['movies_count'])
        print (movies_count)
    else:
    ...
    Lines =get_high_rating_movies(10)['title']
    returnLine = ""
    # Strips the newline character
    for line in Lines:
        #print(line.strip()+",")
...
@app.route('/bestMoviesRecommendationsWithNames', methods=['GET'])
def bestMoviesRecommendationsWithNames():
    ...
    Lines = get_best_movies_metadata_recommendations(imdb_id, movies_count )['title']
    returnLine = ""
    # Strips the newline character
    for line in Lines:
        #print(line.strip()+",")
...
#============================================================================================
@app.route('/getUserRecommendationsWithNames', methods=['GET'])
def getUserRecommendationsWithNames():
    ...
    print(movieUserId)
    Lines = get_user_recommendations(movieUserId, imdb_id, movies_count)['title']
    returnLine = ""
    # Strips the newline character
    for line in Lines:
        #print(line.strip()+",")
...
def home():
    ...
    Lines =get_high_rating_movies(movies_count)['imdb_id']
    returnLine = ""
    # Strips the newline character
    for line in Lines:
        #print(line.strip()+",")
